...
// We create the third tile layer map background.
...
let fourPointFivePlusEarthquakes = new L.LayerGroup();

// 1.2. Add a reference to the tectonic plates group to the overlays object.
let overlays = {
  "Earthquakes": allEarthquakes,
  "Tectonic Plates": tectonicPlates,
  "Earthquakes 4.5+": fourPointFivePlusEarthquakes
};
...
d3.json("https://earthquake.usgs.gov/earthquakes/feed/v1.0/summary/4.5_week.geojson").then(function(data) {
  ...
  // after the marker has been created and styled.
  L.geoJson(data, {
  // Add features as circleMarkers to the map
  pointToLayer: function(feature, latlng) {
    console.log(data);
    return L.circleMarker(latlng);
  },
  ...
  }).addTo(fourPointFivePlusEarthquakes)

  // 2.8. Add the major earthquakes layer to the map.
  fourPointFivePlusEarthquakes.addTo(map);
